...
public class EntityStray extends EntitySkeleton {
    ...
    protected String getLivingSound() {
        return TestMod.MODID + ":entity.stray.ambient";
    }

    @Override
    protected String getHurtSound() {
        return TestMod.MODID + ":entity.stray.hurt";
    }

    @Override
    protected String getDeathSound() {
        return TestMod.MODID + ":entity.stray.death";
    }

    @Override
    protected void func_145780_a(final int p_145780_1_, final int p_145780_2_, final int p_145780_3_, final Block p_145780_4_) {
        this.playSound(TestMod.MODID + ":entity.stray.step", 0.15f, 1.0f);
    }
