package dev.axolotl.testmod.tealsmodloader.commands;
...
public class SpawnEntityCommand extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) {
        ...
        Map<String, EntityInfo> entityRegistry = TestMod.getTEALSInstance().getEntityLookup();
    ...
    public List addTabCompletionOptions(ICommandSender sender, String[] args) {
        ...
        if (args.length == 0) {
            ...
            Collection<String> names = TestMod.getTEALSInstance().getEntityNames();
