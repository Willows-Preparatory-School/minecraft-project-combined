...
import dev.axolotl.tealsmodloader.asm.repackage.net.malisis.core.asm.AsmHook;
import dev.axolotl.tealsmodloader.asm.repackage.net.malisis.core.asm.MalisisClassTransformer;
import dev.axolotl.tealsmodloader.asm.repackage.net.malisis.core.asm.mappings.McpFieldMapping;
import dev.axolotl.tealsmodloader.asm.repackage.net.malisis.core.asm.mappings.McpMethodMapping;
import org.objectweb.asm.tree.*;

import static org.objectweb.asm.Opcodes.*;

public class TestModTransformer extends MalisisClassTransformer {
    ...
    private AsmHook setRotationAnglesHook() {
        ...
        inject.add(new MethodInsnNode(INVOKESTATIC, "dev/axolotl/tealsmodloader/TestModEvents", "setRotationAngles",
        ...
        inject2.add(new MethodInsnNode(INVOKESTATIC, "dev/axolotl/tealsmodloader/TestModEvents", "postSetRotationAngles",
            "(Lnet/minecraft/client/model/ModelBiped;FFFFFFLnet/minecraft/entity/Entity;)V", false));
    ...
    private AsmHook movedTooQuicklyHook() {
        ...
        inject.add(new MethodInsnNode(INVOKESTATIC, "dev/axolotl/tealsmodloader/TestModEvents", "modifyMovementDelta",
    ...
    private AsmHook rotateCorpseHook() {
        ...
        inject.add(new VarInsnNode(FLOAD, 4));
        inject.add(new MethodInsnNode(INVOKESTATIC, "dev/axolotl/tealsmodloader/TestModEvents",
    ...
    private AsmHook moveEntityWithHeadingHook() {
        ...
        inject.add(new VarInsnNode(FLOAD, 1));
        inject.add(new VarInsnNode(FLOAD, 2));
        inject.add(new MethodInsnNode(INVOKESTATIC, "dev/axolotl/tealsmodloader/item/elytra/Elytra",
