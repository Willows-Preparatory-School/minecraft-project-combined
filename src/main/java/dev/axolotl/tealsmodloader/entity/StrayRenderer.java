...
public class StrayRenderer extends RenderSkeleton {
    public static final ResourceLocation texture = new ResourceLocation(TestMod.MODID+":textures/entity/skeleton/stray.png");
    private static final ResourceLocation overlay_texture = new ResourceLocation(TestMod.MODID+":textures/entity/skeleton/stray_overlay.png");
