...
import dev.axolotl.tealsmodloader.blocks.*;
import dev.axolotl.tealsmodloader.entity.TestModEntityList;
import dev.axolotl.tealsmodloader.fluids.*;
import dev.axolotl.tealsmodloader.init.TestModIcons;
import dev.axolotl.tealsmodloader.item.*;
import dev.axolotl.tealsmodloader.item.elytra.ItemElytra;
import dev.axolotl.tealsmodloader.item.elytra.ItemElytraRocket;
...
import dev.axolotl.tealsmodloader.util.PistonBehaviorRegistry;
...
public class TestMod
{
    ...
    public static final String MODID = "tealsmodloader";
    public static final Logger LOG = LogManager.getLogger(MODID);

    @SidedProxy(clientSide = "dev.axolotl.tealsmodloader.ClientProxy", serverSide = "dev.axolotl.tealsmodloader.CommonProxy")
    ...
    public void preInit(FMLPreInitializationEvent event) throws Exception
    {
        ...
        tealsModLoader.preInit(event, this);
