...
import dev.axolotl.tealsmodloader.particles.TestModParticles;
...
public class BlockEndRod extends Block {
    ...
    public BlockEndRod() {
        ...
        setBlockTextureName(TestMod.MODID+":end_rod_FORCE_ERROR");
    ...
    public void randomDisplayTick(World world, int x, int y, int z, Random random) {
        ...
        if (random.nextInt(5) == 0) {
            TestModParticles.spawnEndRodParticle(world, px, py, pz);
        }
    }
