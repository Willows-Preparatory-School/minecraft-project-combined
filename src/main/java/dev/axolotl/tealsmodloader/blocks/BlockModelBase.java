...
import dev.axolotl.tealsmodloader.util.OpenGLHelper;
...
public abstract class BlockModelBase implements ISimpleBlockRenderingHandler {
    ...
    public void renderInventoryBlock(Block block, int meta, int modelID, RenderBlocks renderer) {
        ...
        renderInventoryModel(block, meta, renderer, block.getBlockBoundsMinX(), block.getBlockBoundsMinY(), block.getBlockBoundsMinZ(), block.getBlockBoundsMaxX(), block.getBlockBoundsMaxY(), block.getBlockBoundsMaxZ());
        tessellator.draw();
    ...
    protected void renderInventoryModel(Block block, int meta, RenderBlocks renderer, double minX, double minY, double minZ, double maxX, double maxY, double maxZ) {
        renderStandardInventoryCube(block, meta, renderer, block.getBlockBoundsMinX(), block.getBlockBoundsMinY(), block.getBlockBoundsMinZ(), block.getBlockBoundsMaxX(), block.getBlockBoundsMaxY(), block.getBlockBoundsMaxZ());
    }
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer) {
        return renderStandardWorldCube(world, x, y, z, block, renderer, block.getBlockBoundsMinX(), block.getBlockBoundsMinY(), block.getBlockBoundsMinZ(), block.getBlockBoundsMaxX(), block.getBlockBoundsMaxY(), block.getBlockBoundsMaxZ());
    }

    protected boolean renderStandardWorldCube(IBlockAccess world, int x, int y, int z, Block block, RenderBlocks renderer, double minX, double minY, double minZ, double maxF, double maxY, double maxZ) {
