...
import dev.axolotl.tealsmodloader.util.RandomXoshiro256StarStar;
...
public class TestModFXParticle extends EntityFX
{
    protected int color;
    ...
    public TestModFXParticle(World world, double x, double y, double z, double mx, double my, double mz, int maxAge,
    ...
    protected ResourceLocation[] loadTextures(World world, double x, double y, double z, ResourceLocation texture) {
        this.usesSheet = texture != null && texture.toString().equals(TestMod.MODID+":textures/particle/particles.png");
